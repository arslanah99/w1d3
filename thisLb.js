...
var library = {
  ...
  printPlaylists: function () {
    for(var music in this.playlists){
        var musicInfo = this.playlists[music]
...
//               t02: { id: "t02",
//                      name: "Model View Controller",
//                      artprintPlaylistsist: "James Dempsey",
//                      album: "WWDC 2003"},
//               t03: { id: "t03",
//                      name: "Four Thirty-Three",
//                      artist: "John Cage",
...
//   printPlaylist('p01')
  ...
  addTrack: function (name, artist, album) {
    ...
    // console.log('add track function', name, artist, album)
    return this.tracks[uniqueId] = {
        id: uniqueId,
        name: name,
        artist: artist,
        album: album
...
// library.addPlaylist('The play')
library.printPlaylists()
// console.log(library.printPlaylists())
library.printTracks()
var newTrack = library.addTrack('BagBak', 'Vince Staples', 'Big Fish Theory')
console.log(newTrack)
// console.log(library.addTrack())
library.printPlaylist('p02')
library.addTrackToPlaylist('Cali love', 'p01')
console.log(library.addPlaylist('Sportify Playlist'))